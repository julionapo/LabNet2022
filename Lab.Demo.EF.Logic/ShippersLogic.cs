...
namespace Lab.Demo.EF.Logic
{
    public class ShippersLogic
    {
        ...
        public bool insertShipper(Shippers shippers)
        {
            try
            {
                context.Shippers.Add(shippers);
        ...
        public bool deleteShip(int id)
        {
            try
            {
                context.Shippers.Remove(
                    context.Shippers.Find(id)
                );
                context.SaveChanges();
                return true;
            }
        ...
        public bool updateShip(Shippers ship)
        {
            try
            {
                var shippersUpdate = context.Shippers.Find(ship.ShipperID);
                shippersUpdate.Phone = ship.Phone;
                shippersUpdate.CompanyName = ship.CompanyName;
                shippersUpdate.Orders = ship.Orders;
                context.SaveChanges();
                return true;
            }
            catch (Exception ex)
